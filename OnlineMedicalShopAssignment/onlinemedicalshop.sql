...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2020 at 05:48 PM
...
(3, 'Histasin 20mg', 'Histasin', 5, 'not available');
...
--
ALTER TABLE `medicine`
  MODIFY `mid` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `oid` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
